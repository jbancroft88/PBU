...
namespace PBU
{
    public partial class LDCUSB : Form
    {
        //// PUBLIC VARIABLES 
        ...
        public void btCopy_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ERROR: Unable to initialize data transfer. Check Username and USB Drive letter are correct and that a process direction has been selected");
            }
        }
        ...
        private void timer_copytimeout_Tick(object sender, EventArgs e)
        {
            ...
            if (_ticks > 15)
            {
                ...
                MessageBox.Show("TIMEOUT ERROR" + Environment.NewLine + Environment.NewLine +
                    ...
                    "Check parameters or USB Storage status");
                Controls.Clear();
                InitializeComponent();
            }
        }
        ...
        private void rbBackup_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                _source = "\\\\localhost";
                _dest = ddUSBdrive.SelectedItem.ToString();
            }
        }
        private void rbRestore_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                _source = ddUSBdrive.SelectedItem.ToString();
                _dest = "\\\\localhost";
            }
        }

        private void ddUSBdrive_SelectedIndexChanged(object sender, EventArgs e)
        {
